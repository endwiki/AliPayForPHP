...
class AopClient
{
    ...
    */
    ...
    protected function buildRequestForm($para_temp)
    {
        ...
        foreach (array_keys($para_temp) as $key => $val) {
    ...
    public
    function execute($request, $authToken = null, $appInfoAuthtoken = null)
    {
     ...
     **/
    public
    function checkSignAndDecrypt($params, $rsaPublicKeyPem, $rsaPrivateKeyPem, $isCheckSign, $isDecrypt, $signType = 'RSA')
    {
     ...
     **/
    public
    function encryptAndSign($bizContent, $rsaPublicKeyPem, $rsaPrivateKeyPem, $charset, $isEncrypt, $isSign, $signType = 'RSA')
    {
        // 加密，并签名
        if ($isEncrypt && $isSign) {
     ...
     **/
    public
    function rsaEncrypt($data, $rsaPublicKeyPem, $charset)
    {
        if ($this->checkEmpty($this->alipayPublicKey)) {
            //读取字符串
            $pubKey = $this->alipayrsaPublicKey;
     ...
     **/
    public
    function rsaDecrypt($data, $rsaPrivateKeyPem, $charset)
    {
     ...
     */
    public
    function checkResponseSign($request, $signData, $resp, $respObject)
    {
    ...
    private
    function setupCharsets($request)
    {
...
// 获取加密内容
    ...
    private
    function encryptJSONSignSource($request, $responseContent)
    {
    ...
    private
    function parserEncryptJSONSignSource($request, $responseContent)
    {
    ...
    private
    function parserEncryptJSONItem($responseContent, $nodeName, $nodeIndex)
    {
        $signDataStartIndex = $nodeIndex + strlen($nodeName) + 2;
...
// 获取加密内容
    ...
    private
    function encryptXMLSignSource($request, $responseContent)
    {
    ...
    private
    function parserEncryptXMLSignSource($request, $responseContent)
    {
    ...
    private
    function parserEncryptXMLItem($responseContent, $nodeName, $nodeIndex)
    {
